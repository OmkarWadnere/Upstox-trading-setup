...
public class Script4NextFutureMapperController {
    ...
    public String addScript4NextFutureMapper(@RequestBody Script4FutureMapperRequestDto futureMapperRequestDto) throws UpstoxException {
